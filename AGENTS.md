...
Amity is a **gluten-free social network** with an MSN Messenger–style chat lounge.
Full-stack **Next.js 15** + **TypeScript** + **Tailwind** + **Prisma** + **PostgreSQL**.

Design: glassmorphism with MSN gloss. Brand gradient: `bg-amity-gradient`.
...
- Demo (local only): `maya@amity.app` / `password123`
