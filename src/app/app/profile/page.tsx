        ...
        <div className="px-6 pb-6">
          <div className="-mt-10 flex items-end gap-4">
            ...
            <div className="mb-2 flex-1">
              <h1 className="flex flex-wrap items-center gap-2 font-display text-2xl font-bold text-sage-900 dark:text-white">
                {user.name}
                {user.isPremium && (
                  <span className="chip bg-warm-400/20 text-warm-500">
          ...
          {!user.isPremium && (
            <Link href="/app/premium" className="btn-secondary mt-5 inline-flex">
              <Crown className="h-4 w-4 text-warm-500" /> Upgrade to Premium
            </Link>
          )}
        </div>
      </div>
